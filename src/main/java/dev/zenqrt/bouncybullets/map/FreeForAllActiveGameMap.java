...
public record FreeForAllActiveGameMap(GameMap gameMap, World world, Location intermissionSpawn, List<Location> spawnLocations, List<Location> itemSpawnLocations) implements ActiveGameMap {

    public FreeForAllActiveGameMap(GameMap gameMap, World world, YamlConfiguration configuration) {
        this(
                gameMap,
                world,
