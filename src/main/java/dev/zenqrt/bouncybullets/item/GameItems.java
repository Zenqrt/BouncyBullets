...
public final class GameItems {
    ...
    public static final SniperRifleGunItem SNIPER_RIFLE = registerGun(new SniperRifleGunItem(new GunProperties(5, 20, 0.1, 0.005, 3, 20, 5), new BulletProperties(2, 1000, -0.5F, 8, 8, -0.5F, 100, 0)));
